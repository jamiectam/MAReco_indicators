...
save(HER_agg_wss, 
          file = paste(path, "/output/RV/herring_output/wss_notlengthbased_herring.Rdata", sep = ""))

save(HER_length_wss, 
          file = paste(path, "/output/RV/herring_output/wss_lengthbased_herring.Rdata", sep = ""))

save(HER_agg_strat, 
          file = paste(path, "/output/RV/herring_output/strat_notlengthbased_herring.Rdata", sep = ""))
...
allIndicators <- left_join(inds, short_inds, by = c("YEAR", "ID")) 

write.csv(allIndicators, file = paste(export.filepath, "/eco_indicators_", area, ".csv", sep = ""),
          row.names = FALSE)

save(allIndicators, file=paste(export.filepath, "/eco_indicators_", area, ".Rdata", sep = ""))
